...
const mapToStateProps = (state, ownProps) => ({ stream: state.streams[ownProps.match.params.id] });

export default connect(mapToStateProps, { fetchStream, deleteStream })(StreamDelete);